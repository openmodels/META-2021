...
model_base2 = full_model(rcp="RCP4.5", ssp="SSP2", saf=false, interaction=false, pcf=false, omh=false, amaz=false, gis=false, wais=false, ism=false, amoc=false)
run(model_base2)
...
model_amoc = full_model(rcp="RCP4.5", ssp="SSP2", saf=false, interaction=false, pcf=false, omh=false, amaz=false, gis=false, wais=false, ism=false, amoc="IPSL")
run(model_amoc)
